...
import com.rockstor.VersionAnnotation;

/**
 * This class finds the package info for Rockstor and the VersionAnnotation
...
public class VersionInfo {
    ...
    public static String info() {
        ...
        sb.append("RockStor " + getVersion());
        sb.append(", Subversion " + getUrl() + " -r " + getRevision());
        sb.append(", Compiled by " + getUser() + " on " + getDate());
        return sb.toString();
    }

    public static void main(String[] args) {
        System.out.println("RockStor " + getVersion());

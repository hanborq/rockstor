...
public enum BucketDefaultAcl {

    PRIVATE, PUBLIC_READ, PUBLIC_READ_WRITE, AUTHENTICATIED_READ;

    private static HashMap<BucketDefaultAcl, String> map;
    static {
        map = new HashMap<BucketDefaultAcl, String>();
    ...
    static String getAclString(BucketDefaultAcl acl) {
        return map.get(acl);
    }
}
